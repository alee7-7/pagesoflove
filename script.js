...
// =================================================
   const URL = "https://teachablemachine.withgoogle.com/models/bl6q6ub0J/";
...
// =================================================
   async function predict() {
      ...
      if (maxIndex === 0) {
        ...
        document.querySelector("#mainText2").textContent = "Song";
      } 
      else if (maxIndex === 1) {
        document.querySelector("#mainText1").className = "variable1";
        document.querySelector("#mainText2").textContent = "L";
      } 
      else if (maxIndex === 2) {
        document.querySelector("#mainText1").className = "variable1";
        document.querySelector("#mainText2").textContent = "O";
      } 
      else if (maxIndex === 3) {
        document.querySelector("#mainText1").className = "variable1";
        document.querySelector("#mainText2").textContent = "V";
      }
      else if (maxIndex === 4) {
      document.querySelector("#mainText1").className = "variable1";
        document.querySelector("#mainText2").textContent = "E-mergency";
      }
