...
// =================================================
   async function predict() {
      ...
      //   document.querySelector("#mainText2").textContent = "Stage 5: Courage";
      //   document.querySelector("#image1").src = "./img/5Aa.gif";
      // //   document.body.style.backgroundColor = 'red';
      //   document.body.style.backgroundImage = "";
      // } 
      // else if (maxIndex === 1) {
      //   document.querySelector("#mainText1").className = "pink";
      //   document.querySelector("#mainText2").textContent = "I might've held on to my feelings for too long";
      //   document.querySelector("#image1").src = "./img/5Bb.gif";
      //   document.body.style.backgroundImage = "url('./img/BG-5.png')";
      // } 
      ...
      if (maxIndex === 0) {
         ...
         if (document.querySelector("#image1").src.indexOf("5Aa.gif") === -1) {
            document.querySelector("#image1").src = "./img/5Aa.gif";
         }
         ...
         if (document.querySelector("#image1").src.indexOf("5Bb.gif") === -1) {
            document.querySelector("#image1").src = "./img/5Bb.gif";
         }
