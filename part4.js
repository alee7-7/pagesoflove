...
// =================================================
   async function predict() {
      ...
      //   document.querySelector("#mainText2").textContent = "Stage 4: Fondness";
      //   document.querySelector("#image1").src = "./img/4A.gif";
      // //   document.body.style.backgroundColor = 'red';
      //   document.body.style.backgroundImage = "";
      // } 
      // else if (maxIndex === 1) {
      //   document.querySelector("#mainText1").className = "pink";
      //   document.querySelector("#mainText2").textContent = "It's like a polaroid with no filters";
      //   document.querySelector("#image1").src = "./img/4B.gif";
      //   document.body.style.backgroundImage = "url('./img/BG-4.png')";
      // } 
      ...
      if (document.querySelector("#image1").src.indexOf("4A.gif") === -1) {
         document.querySelector("#image1").src = "./img/4A.gif";
      }
      ...
      if (document.querySelector("#image1").src.indexOf("4B.gif") === -1) {
         document.querySelector("#image1").src = "./img/4B.gif";
      }
